...
const localizationData: LocalizationData = {
    GB: {
        ...
        sidebar_moreActions: "More actions",
        sidebar_lessActions: "Fewer actions",
        ...
        files_deleteAll: "Remove All Files",
        files_deleteAll_confirm: "Are you sure you want to remove and forget all files?",
        ...
        confirm_fromYourRequest: "your request",
        confirm_fromYourRequestReworded: "your request",
        confirm_fromResult: "from",
        confirm_reused: "same as in",
        confirm_notTraceable: "not traceable",
        confirm_notChecked: "too common to trace",
        xai_chain: "How this answer was produced",
        xai_loading: "Reading the trace…",
        xai_loadFailed: "Could not load the call chain.",
        xai_calls: "tool calls",
        xai_failed: "failed",
        xai_untraceable: "not traceable",
        xai_noCalls: "No tools were called for this answer.",
        xai_noParams: "This action takes no parameters.",
        xai_selectHint: "Select a step to see where its values came from.",
        xai_considered: "Considered instead:",
        xai_confidence_high: "nothing to flag",
        xai_confidence_medium: "worth checking",
        xai_confidence_low: "treat with caution",
        xai_explain: "Explain in words",
        xai_explaining: "Writing the explanation…",
        xai_written: "Written by a model from the recorded steps. Every step it names was checked against them.",
        xai_counted: "Counted from the recorded steps. No model involved.",
        xai_explainFailed: "The written explanation could not be produced:",
    ...
    DE: {
        ...
        sidebar_moreActions: "Weitere Aktionen",
        sidebar_lessActions: "Weniger Aktionen",
        sidebar_account: "Account",
        ...
        files_deleteAll: "Alle Dateien entfernen",
        files_deleteAll_confirm: "Sind Sie sicher, dass Sie alle Dateien entfernen und vergessen wollen?",
        ...
        confirm_fromYourRequest: "Ihre Anfrage",
        confirm_fromYourRequestReworded: "Ihre Anfrage",
        confirm_fromResult: "aus",
        confirm_reused: "wie in",
        confirm_notTraceable: "nicht nachvollziehbar",
        confirm_notChecked: "zu häufig, nicht geprüft",
        xai_chain: "Wie diese Antwort entstanden ist",
        xai_loading: "Ablauf wird gelesen…",
        xai_loadFailed: "Die Aufrufkette konnte nicht geladen werden.",
        xai_calls: "Tool-Aufrufe",
        xai_failed: "fehlgeschlagen",
        xai_untraceable: "nicht nachvollziehbar",
        xai_noCalls: "Für diese Antwort wurden keine Tools aufgerufen.",
        xai_noParams: "Diese Aktion hat keine Parameter.",
        xai_selectHint: "Wählen Sie einen Schritt, um die Herkunft seiner Werte zu sehen.",
        xai_considered: "Stattdessen erwogen:",
        xai_confidence_high: "keine Auffälligkeiten",
        xai_confidence_medium: "prüfenswert",
        xai_confidence_low: "mit Vorsicht behandeln",
        xai_explain: "In Worten erklären",
        xai_explaining: "Erklärung wird geschrieben…",
        xai_written: "Von einem Modell aus den aufgezeichneten Schritten verfasst. Jeder genannte Schritt wurde dagegen geprüft.",
        xai_counted: "Aus den aufgezeichneten Schritten gezählt. Ohne Modell.",
        xai_explainFailed: "Die schriftliche Erklärung konnte nicht erstellt werden:",
