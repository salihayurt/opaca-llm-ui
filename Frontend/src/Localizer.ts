...
const localizationData: LocalizationData = {
    GB: {
        ...
        files_deleteAll_failed: "There was an error when removing one or more files from the LLM hosts. Still remove them from the list?",
    ...
    DE: {
        ...
        files_deleteAll_failed: "Fehler beim Entfernen einer oder mehrerer Dateien von den LLM-Hosts. Trotzdem aus der Liste entfernen?",
